           ...
           <div className="grid md:grid-cols-2 gap-12 items-center bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-3xl p-8 md:p-12">
             <div>
               ...
               <p className="text-gray-400 text-lg mb-6">
                 Beyond our pre-built flows, BlackSync becomes your AI engineering team — designing custom agents, workflows, and data flows built around your business.
               </p>
               <p className="text-gray-300 font-medium mb-3">Custom work includes:</p>
               <ul className="space-y-2 mb-8 text-gray-300">
                 <li className="flex items-center gap-2">
                   <div className="h-1.5 w-1.5 rounded-full bg-primary" />
                   Agents for dispatch, quoting, and collections
                 </li>
                 <li className="flex items-center gap-2">
                   <div className="h-1.5 w-1.5 rounded-full bg-primary" />
