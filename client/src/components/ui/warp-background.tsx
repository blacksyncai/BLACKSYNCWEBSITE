...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  return (
    <div className={cn("relative rounded-2xl border border-red-500/30 p-8 md:p-12", className)} {...props}>
      <div
        style={
          {
        ...
        className={
          "pointer-events-none absolute left-0 top-0 size-full overflow-hidden rounded-2xl [clip-path:inset(0)] [container-type:size] [perspective:var(--perspective)] [transform-style:preserve-3d]"
        }
      >
        {/* top side */}
